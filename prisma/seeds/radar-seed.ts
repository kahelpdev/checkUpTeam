...
const METRICS: MetricSeed[] = [
  ...
  {
    key: "pessoas_em_execucao_lista",
    name: "Pessoas em execução",
    description: "Lista de pessoas e suas tarefas em execução no momento",
    formula: "current-tasks raw",
    sourceA: "cardflow:/devbi/current-tasks",
    sourceB: null,
    tolerancePct: null,
  ...
  {
    key: "tempo_em_etapa_por_pessoa",
    name: "Tempo em etapa por pessoa",
    description: "Tempo em minutos comerciais que cada pessoa está no stage atual (recalculado ou espelho)",
    formula: "current-tasks.businessMinutesInStage | businessMinutesBetween(fact_event_stage_history.enteredAt, now)",
    sourceA: "cardflow:/devbi/current-tasks:businessMinutesInStage",
    sourceB: "internal:fact_event_stage_history:businessMinutesBetween(enteredAt, now)",
    tolerancePct: null,
    periodicity: "hourly",
    category: "tempo",
    confidence: "released",
  ...
  {
    key: "total_em_execucao",
    name: "Total em execução",
    description: "Contagem total de cards em execução nas stages monitoradas",
    formula: "count(current-tasks WHERE currentStage em executionStages)",
    sourceA: "cardflow:/devbi/current-tasks:count",
    sourceB: null,
    tolerancePct: null,
    periodicity: "hourly",
    category: "carga",
